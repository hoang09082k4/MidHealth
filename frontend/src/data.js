...
export const specialties = [
  { name: 'Y h?c c? truy?n', image: 'Yhoccotruyen.webp' },
  { name: 'Lao - b?nh ph?i', image: 'laobenhphoi.webp' },
  { name: 'Y h?c th? thao', image: 'yhocthethao.webp' },
  { name: 'C? x??ng kh?p', image: 'Coxuongkhop.webp' },
  { name: 'S?n ph? khoa', image: 'sanphukhoa.webp' },
  { name: 'Nh?n khoa', image: 'Nhankhoa.webp' },
  { name: 'Nam khoa', image: 'Namkhoa.webp' },
  { name: 'V? sinh hi?m mu?n', image: 'vosinhhiemmuon.webp' },
  { name: 'Ngo?i ti?t ni?u', image: 'Ngoaitietnieu.webp' },
  { name: 'Ngo?i th?n kinh', image: 'Ngoaithankinh.webp' },
  { name: 'N?i t?ng qu?t', image: 'Noitongquat.webp' },
  { name: 'Ngo?i ni?u', image: 'ngoaitietnieu (1).webp' },
  { name: 'Dinh d??ng', image: 'Dinhduong.webp' },
  { name: 'Ti?u h?a', image: 'tieuhoa.webp' },
  { name: 'Nhi khoa', image: 'Nhikhoa.webp' },
  { name: 'Da li?u', image: 'Dalieu.webp' },
  { name: 'Ngo?i l?ng ng?c - m?ch m?u', image: 'ngoailongngucmachmau.webp' },
  { name: 'Ch?n ?o?n h?nh ?nh', image: 'Chandoanhinhanh.png' },
  { name: 'Ng?n ng? tr? li?u', image: 'ngonngutrilieu.webp' },
  { name: 'R?ng - H?m - M?t', image: 'Ranghammat.webp' },
  { name: 'N?i th?n kinh', image: 'Noithankinh.webp' },
  { name: 'Tai - M?i - H?ng', image: 'taimuihong.webp' },
  { name: 'Ung b??u', image: 'ungbuou.webp' },
  { name: 'Tim m?ch', image: 'timmach.webp' },
  { name: 'L?o khoa', image: 'laokhoa.webp' },
  { name: 'Ch?n th??ng ch?nh h?nh', image: 'Chanthuongchinhhinh.webp' },
  { name: 'H?i s?c - c?p c?u', image: 'hoisuccapcuu.png' },
  { name: 'Ngo?i t?ng qu?t', image: 'ngoaitongquat.webp' },
  { name: 'G?y m? h?i s?c', image: 'Gaymehoisuc.webp' },
  { name: 'Y h?c d? ph?ng', image: 'yhocduphong.webp' },
  { name: 'Truy?n nhi?m', image: 'truyennhiem.webp' },
  { name: 'N?i th?n', image: 'Noithan.webp' },
  { name: 'N?i ti?t', image: 'Noitiet.webp' },
  { name: 'T?m th?n', image: 'tamthan.webp' },
  { name: 'H? h?p', image: 'Hohap.webp' },
  { name: 'X?t nghi?m', image: 'xetnghiem.webp' },
  { name: 'Huy?t h?c', image: 'huyet-hoc.webp' },
  { name: 'T?m l?', image: 'tamly.webp' },
  { name: 'Ph?u thu?t t?o h?nh', image: '37_phauthuattaohinhthammy.webp' },
  { name: '?a khoa', image: 'Noitongquat (1).webp' },
  { name: 'Ph?c h?i ch?c n?ng', image: 'vatlitrilieu.webp' },
];

export const clinics = [
  {
    avatar: 'phong_kham_san_phu.jpg',
    gallery: ['phong_kham_san_phu.jpg'],
    name: 'Phòng khám Sản Phụ Khoa 13 Cao Thắng',
    subtitle: 'Chăm sóc sức khỏe sản phụ khoa',
    address: '13 Cao Thắng, Phường Bàn Cờ, TP. Hồ Chí Minh',
    intro: 'Phòng khám Sản Phụ Khoa 13 Cao Thắng tiếp nhận khám thai, siêu âm, tư vấn sức khỏe sinh sản và chăm sóc phụ khoa định kỳ. Người bệnh có thể đặt lịch trước để chủ động thời gian thăm khám.',
    services: ['Sản phụ khoa', 'Khám thai', 'Siêu âm', 'Tư vấn sức khỏe sinh sản'],
    specialties: ['Sản phụ khoa', 'Khám thai', 'Siêu âm', 'Tầm soát phụ khoa'],
    doctors: ['BS.CKII Nguyễn Thị Thu Lan', 'BS Trần Thị Ngọc Mai', 'ThS.BS Phạm Minh Anh'],
    hours: [
      { label: 'Thứ 2 - Thứ 6', time: '17h00 - 20h00' },
      { label: 'Thứ 7', time: '8h00 - 17h00' },
      { label: 'Chủ nhật', time: '8h00 - 11h30' },
    ],
  },
  {
    avatar: 'phong_kham_my_my.jpg',
    gallery: ['phong_kham_my_my.jpg'],
    name: 'Phòng khám Nhi Mỹ Mỹ',
    subtitle: 'Khám và tư vấn sức khỏe trẻ em',
    address: '105/10 Nguyễn Thị Tú, Phường Bình Tân, TP. Hồ Chí Minh',
    intro: 'Phòng khám Nhi Mỹ Mỹ hỗ trợ khám bệnh nhi, tư vấn dinh dưỡng, theo dõi tăng trưởng và các vấn đề hô hấp, tiêu hóa thường gặp ở trẻ em.',
    services: ['Nhi khoa', 'Dinh dưỡng', 'Hô hấp', 'Tiêu hóa'],
    specialties: ['Nhi khoa', 'Dinh dưỡng', 'Hô hấp', 'Tiêu hóa', 'Tư vấn tiêm ngừa'],
    doctors: ['BS Nguyễn Minh Mỹ', 'BS Lê Hoàng Phúc', 'ThS.BS Trần Hải Yến'],
    hours: [
      { label: 'Thứ 2 - Thứ 6', time: '17h00 - 20h30' },
      { label: 'Thứ 7', time: '8h00 - 18h00' },
      { label: 'Chủ nhật', time: '8h00 - 11h30' },
    ],
  },
  {
    avatar: 'phong_kham_suc_khoe.jpg',
    gallery: ['phong_kham_suc_khoe.jpg', 'phong_kham_suc_khoe.jpg'],
    name: 'Trung Tâm Chăm Sóc Sức Khỏe Cộng Đồng - CHAC',
    subtitle: 'Đa chuyên khoa - hướng về cộng đồng',
    ...
    hours: [
      ...
      { label: 'Thứ 7', time: '7h00 - 16h30' },
      { label: 'Chủ nhật', time: 'Nghỉ' },
    ],
  },
  {
    avatar: 'phong_kham_da_lieu.jpg',
    gallery: ['phong_kham_da_lieu.jpg'],
    name: 'Phòng khám Da liễu Shine Clinic',
    subtitle: 'Da liễu và chăm sóc thẩm mỹ da',
    address: '06 Trương Quyền, P.6, Q.3, TP.HCM',
    intro: 'Phòng khám Da liễu Shine Clinic cung cấp dịch vụ khám da liễu, tư vấn chăm sóc da, điều trị mụn, nám, viêm da và các vấn đề da thường gặp.',
    services: ['Da liễu', 'Điều trị mụn', 'Chăm sóc da', 'Tư vấn thẩm mỹ da'],
    specialties: ['Da liễu', 'Điều trị mụn', 'Nám da', 'Viêm da cơ địa'],
    doctors: ['BS Nguyễn Phương Shine', 'ThS.BS Lê Thanh Thảo', 'BS Trần Minh Đức'],
    hours: [
      { label: 'Thứ 2 - Thứ 6', time: '9h00 - 20h00' },
      { label: 'Thứ 7', time: '9h00 - 18h00' },
      { label: 'Chủ nhật', time: 'Nghỉ' },
    ],
  },
];
